...
b=. 'port 65220'r1'read from t'
'base does not match clone_0'assert b-:'port 65221'r1'read from t'
'base does not match clone_1'assert b-:'port 65221'r1'read from t'